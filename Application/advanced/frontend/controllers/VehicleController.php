...
class VehicleController extends Controller
{
    ...
    public function behaviors()
    {
        return [
            'access' => [
                ...
                'rules' => [
                    [
                        'actions' => ['logout', 'index', 'create', 'update', 'view', 'air', 'sea', 'road'],
                        'allow' => true,
                        'roles' => ['@'],
                    ],
                ],
    ...
    public function actionAir()
    {
        $searchModel = new VehicleSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
        $dataProvider-> query->andFilterWhere(['type'=>'Air']);
    ...
    public function actionSea()
    {
        $searchModel = new VehicleSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
        $dataProvider->query->andFilterWhere(['type'=>'Sea']);
    ...
    public function actionRoad()
    {
        $searchModel = new VehicleSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
        $dataProvider->query->andFilterWhere(['type'=>'Road']);
