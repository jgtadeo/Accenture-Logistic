    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <?php
                if(Yii::$app->user->can('Super Admin') || Yii::$app->user->can('Barangay') || Yii::$app->user->can('City/Municipal') || Yii::$app->user->can('Regional')){
                    echo
                    '<li><a href="index.php?r=supply"><i class="fa fa-shopping-basket"></i> <span>Supplies</span></a></li>'
                    ;}
                ?>
                ...
                if(Yii::$app->user->can('Super Admin') || Yii::$app->user->can('Barangay') || Yii::$app->user->can('City/Municipal') || Yii::$app->user->can('Regional')){
                    ...
                    <ul class="treeview-menu">
                        <li><a href="index.php?r=user"><i class="fa fa-circle-o"></i>Volunteers</a></li>
